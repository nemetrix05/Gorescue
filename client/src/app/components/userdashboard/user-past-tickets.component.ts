...
@Component({
	selector: 'user-past-tickets',
	templateUrl:'../../views/userdashboard/user-past-tickets.html',
	providers:[UserService,TicketService]
})

export class UserPastTicketsComponent implements OnInit {
	...
	constructor(private _route:ActivatedRoute,
		...
		this.title='TICKETS DE EVENTOS PASADOS';
		this.next_page=1;
  		this.prev_page=1;
  		this.cur_page=1;
	...
	ngOnInit(){
		...
		console.log('Past tickets component loaded '+this.user._id);
		this.loadTickets();
	}
	...
	loadTickets(){
		...
		this._route.params.forEach((params:Params)=>{
			...
			let from=new Date('2000-01-01').toISOString();
